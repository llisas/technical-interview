...
describe('paginationService', () => {
  ...
  it('should handle next page correctly', async () => {
    ...
    await paginationService.handleNext(nextPageUrl, currentPage, paginationAdapter);
  ...
  it('should handle previous page correctly', async () => {
    ...
    await paginationService.handlePrevious(previousPageUrl, currentPage, paginationAdapter);
